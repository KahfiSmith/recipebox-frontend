...
<template>
  <section class="flex flex-col items-center gap-3 py-16 text-center">
    <p class="text-5xl font-extrabold text-[color:color-mix(in_oklab,var(--recipe-sand),white_40%)]">
      404
    </p>
    <h1 class="text-2xl font-semibold text-[color:var(--recipe-ink)]">Page not found</h1>
